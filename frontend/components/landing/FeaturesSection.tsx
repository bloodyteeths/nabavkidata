...
const features = [
    {
        ...
        description: "Поставете прашање и добијте одговор веднаш од 31,592 документи. AI го чита содржината, не општи претпоставки."
    },
    {
        icon: Search,
    ...
    },
    {
        ...
        description: "Пребарувајте во 10,693 PDF документи. AI ги извлекува клучните барања и спецификации за секунди."
    },
    {
        icon: Bell,
        title: "AI Препораки",
        description: "Персонализирани стратегии за наддавање, оптимални цени и тајминг базирани на 5 години историски податоци."
    },
    {
        icon: Brain,
