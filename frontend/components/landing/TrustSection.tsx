            ...
            <div className="container px-4 md:px-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-4xl mx-auto">
                        {trustBadges.map((badge, index) => (
                            <motion.div
                                ...
                                className="p-4 md:p-6 rounded-xl bg-white/5 border border-white/10 text-center hover:bg-white/10 transition-colors"
                            >
                                ...
                                <h3 className="text-sm md:text-base font-bold mb-1 md:mb-2 text-white">{badge.title}</h3>
                ...
                <div>
                    <div className="text-center mb-8 md:mb-12">
                        <p className="text-xs md:text-sm text-gray-400 uppercase tracking-wider mb-6 md:mb-8">
                ...
                <div className="mt-12 md:mt-16 text-center">
                    <div className="inline-flex flex-wrap items-center justify-center gap-4 md:gap-6 text-xs md:text-sm text-gray-400">
