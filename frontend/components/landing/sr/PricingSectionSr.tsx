...
export default function PricingSectionSr() {
        ...
        <section id="pricing" className="py-24 relative">
            ...
            <div className="container px-4 md:px-6 relative">
                <div className="text-center mb-12">
                    ...
                    >
                        Jednostavne <span className="text-gradient">Cene</span>
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    >
                        Izaberite plan koji najviše odgovara vašim potrebama. Bez skrivenih troškova.
                    </motion.p>
                    ...
                    >
                        ...
                        <div className="text-left">
                            <p className="text-foreground font-semibold">7-dnevna besplatna proba Pro plana</p>
                            <p className="text-muted-foreground text-sm">25 AI poruka • 10 ekstrakcija • 10 izvoza</p>
                        </div>
                        <Button
                    ...
                    {currency === "eur" && (
                        ...
                        >
                            Plaćanje karticom ili SEPA direktnim zaduženjem
                        </motion.p>
                    )}
                </div>
                                ...
                                <div className="mb-6">
                                    <div className="flex items-baseline gap-1">
                                        ...
                                        <span className="text-muted-foreground text-sm">
                                            {currency === "mkd" ? "din" : ""}/mes
                                        </span>
                                    </div>
                                    {billingCycle === "yearly" && price > 0 && (
                                        <p className="text-gray-500 text-xs mt-1">
                                            Naplata {formatPrice(price, currency)} {currency === "mkd" ? "din" : ""} godišnje
                                        </p>
                                    )}
                                </div>
                ...
                >
                    Sva plaćanja su bezbedna i procesuirana preko Stripe-a. Otkažite u bilo kom trenutku.
                </motion.p>
            </div>
        </section>
    );
