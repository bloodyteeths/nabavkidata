...
ssh -i $SSH_KEY $EC2_HOST "cd $PROJECT_DIR/scraper && source ../venv/bin/activate && source $PROJECT_DIR/backend/.env && scrapy crawl nabavki -s CLOSESPIDER_ITEMCOUNT=3 -s LOG_LEVEL=INFO 2>&1 | tail -100"
